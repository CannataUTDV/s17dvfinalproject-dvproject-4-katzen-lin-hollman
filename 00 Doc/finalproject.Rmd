---
title: '<center><b>An Exploration of Texas Government Educational Spending and Regional Income Levels </b></center>'
...
output:
  ...
  html_notebook:
    ...
    toc: yes
---
![flag](../03 Visualizations/flag.jpg)
...
## 1. Raw (Pre-ETL) CSVs:
You can see the raw csv file for demogrpahic income contains data across more subdivisions than were necessary in this project. 
```{r getpre}
